...
if(isset($_GET['t'])):
$_POST['tipo_oferta'] = $_GET['t'];
endif;

if(isset($_GET['p'])):
$_POST['tipo_propiedad'] = $_GET['p'];
endif;

if(empty($_POST)): header('Location: ./#filter-div'); return;
endif;
...
$ciudad = NULL; $barrio = NULL; $area = NULL; $precio = NULL; $codigo = NULL;
...
$query_propiedades = $con_propiedades->FilterPropiedades($tipo_oferta, $tipo_propiedad, $ciudad, $barrio, $area, $precio, 0);
$query_propiedades_number = $con_propiedades->FilterPropiedadesNumber($tipo_oferta, $tipo_propiedad, $ciudad, $barrio, $area, $precio);

# Número de Paginas.
$paginas = ceil($query_propiedades_number->num_rows / 6);

# Para cuando hay una busqueda de codigo.
if($codigo): $query_propiedades = $con_propiedades->SelPropiedad($codigo);
$query_propiedades_number = $query_propiedades; 
endif;
...
<html lang="es">
      ...
      <form class="row" id="main-filter" action="filtrar-propiedades" method="POST">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="select-wrap">
            ...
            <select name="tipo_oferta" class="form-control d-block rounded-0" required chosen="<?= $tipo_oferta ?>">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
          <div class="select-wrap">
            <span class="icon icon-arrow_drop_down"></span>
            <select name="tipo_propiedad" class="form-control d-block rounded-0" chosen="<?= $tipo_propiedad ?>">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="select-wrap">
            <span class="icon icon-arrow_drop_down"></span>
            <select name="ciudad" class="form-control d-block rounded-0" chosen="<?= $ciudad ?>">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="400">
          <div class="select-wrap">
            <span class="icon icon-arrow_drop_down"></span>
            <select name="barrio" class="form-control d-block rounded-0" chosen="<?= $barrio ?>">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="500">
          <div class="select-wrap">
            <span class="icon icon-arrow_drop_down"></span>
            <select name="area" class="form-control d-block rounded-0" chosen="<?= $area ?>">
              <option value="-">Área (m2)</option>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="600">
          <div class="select-wrap">
            <span class="icon icon-arrow_drop_down"></span>
            <select name="precio" class="form-control d-block rounded-0" chosen="<?= $precio ?>">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="700">
          <div class="mb-4">
            <div class="form-group">
              <input type="text" name="codigo" class="form-control" placeholder="Código" value="<?= $codigo ?>" title="Si rellena esta información, la información previamente indicada no será tomada en cuenta." autocomplete="disabled">
            </div>
          </div>
        </div>
  ...
  <div class="site-section site-section-sm bg-light">
    <div class="container">
      <?php if($query_propiedades_number->num_rows): ?>
      <div class="row mb-5">
        <div class="col-12">
          <div class="site-section-title">
            <h2>¡AQUÍ ESTÁN LOS RESULTADOS!</h2>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <div class="site-pagination">
            ...
            <?php $i == 1 ? $act = ' class="active" ' : $act = null; ?>
            <a href="javascript:;" <?= $act ?> data-action="pagination"><?= $i ?></a>
            <?php endfor; ?>
          </div>
        </div>  
      </div>
