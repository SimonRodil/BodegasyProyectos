...
<html lang="es">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-10">
          ...
          <div><a href="./index.php">Inicio</a> <span class="mx-2 text-white">&bullet;</span> <strong class="text-white">Nuestros Servicios</strong></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-4 mb-4">
          <a href="javascript:;" data-toggle="modal" data-target="#servicio-1" class="service text-center border rounded">
            ...
            <h2 class="service-heading">Colocación de Inmuebles</h2>
            <p><span class="read-more">Saber más</span></p>
          </a>
        </div>
        <div class="col-lg-4 mb-4">
      ...
      <div class="row d-flex justify-content-center">
        ...
        <div class="col-lg-4 mb-4">
          <a href="javascript:;" data-toggle="modal" data-target="#servicio-4" class="service text-center border rounded">
            ...
            <h2 class="service-heading">Administración de Inmuebles</h2>
            <p><span class="read-more">Saber más</span></p>
          </a>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-8" data-aos="fade-up">
          ...
          <p class="lead text-white">Estás en el sitio web donde podrás encontrar lo que estás buscando, tenemos todo en localces, Inmuebles, oficinas y más.</p>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Colocación de Inmuebles</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body"><p>Nos interesa que los propietarios administren sus propios inmuebles por lo que ofrecemos el servicio de COLOCACIÓN, el cual consiste en la promoción y publicidad del inmueble comercial o industrial a través de canales digitales, físicos y con nuestros clientes. En el momento que tenemos el cliente especifico para su inmueble nosotros nos encargamos de todo el proceso de arrendamiento, el cual consiste en el estudio de viabilidad o de riesgo del cliente a través de la aseguradora de su preferencia, la elaboración de contratos de arrendamiento, el inventario escrito y fotográfico del inmueble firmado por el cliente y la entrega del inmueble. </p>
        </div>
  ...
  <div id="servicio-4" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Administración de Inmuebles</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
...
Garantizamos el pago de su arrendamiento en los primeros 10 días del mes, depositados a su cuenta bancaria sin necesidad de tramites, también tramitamos el estudio de viabilidad o de riesgo del cliente, la póliza de arrendamiento, la elaboración de contratos de arrendamiento, el inventario escrito y fotográfico del inmueble firmado por el cliente y la entrega del inmueble. Además se asignará un asesor el cual dará una atención personalizada a cualquier novedad que se pueda presentar con su inmueble.
