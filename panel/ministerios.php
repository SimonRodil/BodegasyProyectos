...
require ('../mod/ministerios.php');
$con_ministerios = new Ministerios();
$query_lideres = $con_ministerios->SelLideres(); ?>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Registro de Ministerios</h4>
                </div>
                <div class="card-body">
                  ...
                  <div class="col-md-6 col-xs-6">
                    <div class="form-group">
                      <select name="leader" class="form-control">
                        <option value="-">-</option>
                        <?php foreach($query_lideres as $leader): ?>
      ...
      <div id="nuevo-registro" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form-nuevo-registro" action="../dri/ministerios/new.php">
                <div class="row">
                  <div class="col-md-6 col-xs-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Nombre</label>
      ...
      <div id="actualizar-registro" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form-actualizar-registro" action="../dri/ministerios/upd.php">
                <input type="hidden" name="id">
                <div class="row">
                  <div class="col-md-6 col-xs-6">
                    <div class="form-group">
