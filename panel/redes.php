...
require ('../mod/redes.php');
$con_redes = new Redes();
$query_mentores = $con_redes->SelMentores();
$query_redes = $con_redes->SelRedes();
...
<body class="">
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-danger">
                  <h4 class="card-title">Registro de Redes</h4>
                </div>
                <div class="card-body">
            ...
            <div class="modal-body">
              <form id="ver-registro">
                <div class="row">
                  ...
                  <div class="col-md-4 col-xs-6">
                    <div class="form-group">
                      <select name="mentor" class="form-control">
                        <option value="-">- Mentor de Zona -</option>
                        <?php foreach($query_mentores as $mentor): ?>
                        <option value="<?= $mentor['id'] ?>"><?= $mentor['name'] ?> <?= $mentor['lastname'] ?></option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
                  <div class="col-md-4 col-xs-6">
                    <div class="form-group">
                      <select name="network_father" class="form-control">
                        <option value="-">- Red Superior -</option>
                        <?php foreach($query_redes as $red): ?>
                        <option value="<?= $red['id'] ?>"><?= $red['name'] ?> (<?= $red['mentor_name'] ?>)</option>
                        <?php endforeach; ?>
                      </select>
                    </div>
                  </div>
      ...
      <div id="nuevo-registro" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form-nuevo-registro" action="../dri/redes/new.php">
                <div class="row">
                  <div class="col-md-4 col-xs-6">
                    <div class="form-group">
                      <label class="bmd-label-floating">Nombre</label>
      ...
      <div id="actualizar-registro" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form-actualizar-registro" action="../dri/redes/upd.php">
  ...
  <!-- Form, Modal, Scripts -->
  <script src="../assets/panel/js/redes/script.js"></script>
</body>
