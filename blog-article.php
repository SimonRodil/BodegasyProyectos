...
if(!isset($_GET['id'])): header('Location: ./blog'); return;
endif;

require ('mod/config.php');
require ('mod/blog.php');
$con_blog = new Blogs();
$query_blog = $con_blog->SelBlog($_GET['id']);

if(!$query_blog->num_rows): header('Location: ./blog'); return;
endif;
...
<html lang="es">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(assets/images/blog/<?= $blog['image'] ?>);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2"><?= $blog['title'] ?></h1>
            <div><a href="./index.php" class="orange-color">Inicio</a> <span class="mx-2 text-white">&bullet;</span> <a href="./blog.php">Blog</a> <span class="mx-2 text-white">&bullet;</span> <strong class="text-white"><?= $blog['title'] ?></strong></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 mb-5 border p-3">
            <div class="row">
              <div class="col-md-12 mb-3">
                <img src="assets/images/blog/<?= $blog['image'] ?>" class="img-fluid">
              </div>
            </div>
            <hr>
            <div class="row">
              <div class="col-md-12 mb-3 mb-md-0">
                <h3><?= $blog['title'] ?></h3>
                <small><span class="icon-calendar"></span>: <?= date_format(date_create($blog['to_publish']), 'd/m/Y') ?></small>
              </div>
            </div>
            <hr>
            <div class="row">
