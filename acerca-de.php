  ...
  <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(assets/images/about_us.JPG); background-position: bottom" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        <div class="col-md-10">
          <h1 class="mb-2">Sobre Nosotros</h1>
          <div><a href="./index.php" class="orange-color">Inicio</a> <span class="mx-2 text-white">&bullet;</span> <strong class="text-white">Sobre Nosotros</strong></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/images/aboutus_1.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6 ml-auto"  data-aos="fade-up" data-aos-delay="200">
            <div class="site-section-title mb-3">
              <h2>¿Quienes Somos?</h2>
            </div>
            <p>Somos una Red de Profesionales con la mayor experiencia en finca Raíz y el Sector Inmobiliario. Nuestra Agencia te Ofrece Importantes Proyectos en Alquiler, Venta y Administración de Bodegas, Oficinas, Locales, Lotes y Consultorios. Somos aliados estratégicos, ya que tomamos cada caso y requerimiento como si fuera nuestro y nos apropiamos de él hasta lograr materializar y concretar la consecución de su espacio. </p>
          </div>
		  <div class="col-md-12 mt-5" data-aos="fade-up">
            <p>Así mismo en el área de inversiones conocemos perfectamente el mercado inmobiliario industrial y comercial, en cuanto a precios, áreas, ubicaciones, valorización, plusvalía y rentabilidad se trata. Por lo tanto asesoramos nuestros clientes inversionistas, teniendo en cuenta toda estas variables y haciendo un análisis detallado, consiguiendo con esto tomar las mejores decisiones y sacar el mayor provecho a su capital.</p>
		  </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section bg-light">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-5 order-md-2" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/images/aboutus_2.jpg" alt="Image" class="img-fluid">
          </div>
          <div class="col-md-6 mr-auto order-md-1"  data-aos="fade-up" data-aos-delay="200">
            <div class="site-section-title mb-3">
              <h2>Mision & Visión</h2>
            </div>
			<div class="row text-justify">
			  <div class="col-md-6">
				<p><b>Misión</b>: Asesorar de forma integral a nuestros clientes en la consecución del espacio ideal para su empresa o el manejo de su inversión, así mismo en la comercialización de inmuebles industriales y comerciales, apoyados en la experiencia y conocimiento del mercado inmobiliario. </p>
			  </div>
			  <div class="col-md-6">
				<p><b>Visión</b>: En el año 2030 seremos la inmobiliaria líder con mayor reconocimiento a nivel del departamento de Antioquia en las actividades de ventas y arrendamientos de inmuebles comerciales e industriales, lideres en servicio al cliente y el entendimiento de sus necesidades especificas. </p>
			  </div>
			</div>
          </div>
        </div>
    ...
    <div class="site-section border-top bg-light" hidden>
    <div class="container">
        ...
        <div class="nonloop-block-13 owl-carousel">
          ...
          <div class="slide-item">
            <div class="team-member text-center">
              <img src="assets/images/person_1.jpg" alt="Image" class="img-fluid mb-4 w-50 rounded-circle mx-auto">
              <div class="text p-3">
                <h2 class="mb-2 font-weight-light text-black h4">Megan Smith</h2>
          ...
          <div class="slide-item">
            <div class="team-member text-center">
              <img src="assets/images/person_2.jpg" alt="Image" class="img-fluid mb-4 w-50 rounded-circle mx-auto">
              <div class="text p-3">
                <h2 class="mb-2 font-weight-light text-black h4">Brooke Cagle</h2>
                <span class="d-block mb-3 text-white-opacity-05">Guest</span>
                <p class="mb-5">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi dolorem totam non quis facere blanditiis praesentium est. &rdquo;</p>
          ...
          <div class="slide-item">
            <div class="team-member text-center">
              <img src="assets/images/person_3.jpg" alt="Image" class="img-fluid mb-4 w-50 rounded-circle mx-auto">
              <div class="text p-3">
                <h2 class="mb-2 font-weight-light text-black h4">Philip Martin</h2>
                <span class="d-block mb-3 text-white-opacity-05">Guest</span>
                <p class="mb-5">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi dolorem totam non quis facere blanditiis praesentium est. &rdquo;</p>
