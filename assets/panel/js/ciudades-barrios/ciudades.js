$(document).ready(function() {
  $('table.ciudades').on( 'click', 'tr', function () { 
     if ( $(this).hasClass('selected') ) {
         ...
         data = $('table.ciudades').DataTable().row('.selected').data();
     }
  });
  var table = $('table.ciudades').DataTable({
    ajax: {
      ...
      buttons: [
        {
          ...
          action: function(){
              ...
              table_barrios.ajax.url('../dri/barrios/sel.php?ciudad=' + data.id).load();
